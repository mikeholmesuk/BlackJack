...
var playerDataService = require('../services/data/PlayerDataService.js');

router.get('/', function(req, res, next) {

    playerDataService.list()
...
router.get('/:username', function(req, res, next) {
    ...
    playerDataService.findPlayerByUsername(req.params.username, {})
...
router.delete('/:_id', function(req, res, next) {
    ...
    playerDataService.deleteById(req.params._id)
    .then(function(result) {
